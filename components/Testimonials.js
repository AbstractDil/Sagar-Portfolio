...
<section className="text-gray-600 body-font">
  <div className="container px-5 pb-24 mx-auto">
    <h1 className="text-3xl font-medium title-font text-gray-900 mb-12 text-center"><span className="inline-block p-4 leading-none text-center whitespace-nowrap align-baseline font-bold bg-teal-600 text-white rounded">What People Say</span></h1>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full hover:shadow-lg">
